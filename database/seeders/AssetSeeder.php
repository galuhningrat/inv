...
class AssetSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $assets = [
            ...
            ['id' => '2024/01/JAR-0001', 'name' => 'Splicer', 'type' => 'JAR', 'brand' => 'Fusion', 'serial' => 'SPLCR001', 'location' => 'Ruang Server', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 15000000, 'purchaseDate' => '2024-01-01', 'image' => 'assets/splicer.jpg', 'qrcode' => 'SPLCR001BC'],
            ['id' => '2024/01/JAR-0002', 'name' => 'Fiber optic 250 meter', 'type' => 'JAR', 'brand' => 'Generic', 'serial' => 'FO250M001', 'location' => 'Gudang', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 240000, 'purchaseDate' => '2024-01-01', 'image' => 'assets/cable-fiber-optic-outdoor-250-meter.jpg', 'qrcode' => 'FO250M001BC'],
            ['id' => '2024/01/JAR-0003', 'name' => 'Switch tplink', 'type' => 'JAR', 'brand' => 'tp-link', 'serial' => 'SWTPLINK001', 'location' => 'Ruang Server', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 750000, 'purchaseDate' => '2024-01-01', 'image' => 'assets/switch-tp-link.jpg', 'qrcode' => 'SWTPLINK001BC'],
            ['id' => '2024/01/JAR-0004', 'name' => 'HTB', 'type' => 'JAR', 'brand' => 'Netlink', 'serial' => 'HTB001', 'location' => 'Gudang', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 100000, 'purchaseDate' => '2024-01-01', 'image' => 'assets/htb.jpg', 'qrcode' => 'HTB001BC'],
            ['id' => '2024/01/FUR-0002', 'name' => 'Rak rako', 'type' => 'FUR', 'brand' => 'Raaco', 'serial' => 'RAKRAKO001', 'location' => 'Gudang', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 450000, 'purchaseDate' => '2024-01-01', 'image' => 'assets/rak-rako.jpg', 'qrcode' => 'RAKRAKO001BC'],
            ['id' => '2024/01/ATK-0001', 'name' => 'CRIMPING BIRU schneider', 'type' => 'ATK', 'brand' => 'Schneider', 'serial' => 'CRIMPSCH001', 'location' => 'Toolbox', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 350000, 'purchaseDate' => '2024-01-01', 'image' => 'assets/crimping-biru.jpg', 'qrcode' => 'CRIMPSCH001BC'],
            ['id' => '2024/01/LAN-0001', 'name' => 'Container Box cb 82 hijau', 'type' => 'LAN', 'brand' => 'Shinpo', 'serial' => 'CBH001', 'location' => 'Gudang', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 140000, 'purchaseDate' => '2024-01-01', 'image' => 'assets/Container-Box-cb-82-hijau.jpg', 'qrcode' => 'CBH001BC'],
            ['id' => '2024/01/ELK-0025', 'name' => 'Sensor LDR', 'type' => 'ELK', 'brand' => 'Generic', 'serial' => 'SNSRLDR001', 'location' => 'Laci Biru A', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 400, 'purchaseDate' => '2024-01-01', 'image' => 'assets/Sensor-LDR.jpg', 'qrcode' => 'SNSRLDR001BC'],
            ['id' => '2024/01/ELK-0135', 'name' => 'ARDUINO UNO R3', 'type' => 'ELK', 'brand' => 'Arduino', 'serial' => 'ARDUINOUNOR3001', 'location' => 'Lemari Komponen', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 99900, 'purchaseDate' => '2024-01-01', 'image' => 'assets/Arduino_Uno_-_R3.jpg', 'qrcode' => 'ARDUINOUNOR3001BC'],
            ['id' => '2024/01/ELK-0116', 'name' => 'NodeMCU (ESP8266)', 'type' => 'ELK', 'brand' => 'Amica', 'serial' => 'NODEMCUESP8266001', 'location' => 'Lemari Komponen', 'condition' => 'Baik', 'status' => 'Tersedia', 'price' => 39500, 'purchaseDate' => '2024-01-01', 'image' => 'assets/NodeMCU-(ESP8266).jpg', 'qrcode' => 'NODEMCUESP8266001BC'],
        ];
